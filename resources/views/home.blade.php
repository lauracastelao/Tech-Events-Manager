  ...
  <body class="bg-gradient-to-r from-indigo-300 via-purple-500 to-pink-300">
    ...
    <nav class="flex py-5 bg-purple-500 text-white">
      <div class="w-1/2 px-12 mr-auto flex">
        ...
        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cat" class="ml-4 mt-2 w-4 h-4" mt-2role="img" xmlns="http://www.w3.org/2000/svg" 
viewBox="0 0 512 512">
        <path fill="currentColor" d="M290.59 192c-20.18 0-106.82 1.98-162.59 85.95V192c0-52.94-43.06-96-96-96-17.67 0-32 14.33-32 32s14.33 32 32 32c17.64 0 32 14.
...
16-16-16s7.16-16 16-16 16 7.16 16 16-7.16 16-16 16zm80 0c-8.84 0-16-7.16-16-16s7.16-16 16-16 16 7.16 16 16-7.16 16-16 16z"></path>
...
hover:-translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
